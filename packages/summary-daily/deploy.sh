...
# Configuration
STACK_NAME="hacker-news-daily-summarizer-${ENV}"
FUNCTION_NAME="hacker-news-daily-summarizer-${ENV}"
REGION="us-east-1"
DEPLOY_BUCKET_NAME="hn-tracker-lambda-1742836337"
FUNCTION_ZIP="daily-function.zip"
...
echo "Your daily summarizer function is now scheduled to run every day at 08:00 UTC." 