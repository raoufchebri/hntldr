...
function getDefaultDateRange() {
  ...
  const daysToLastFriday = ((today + 2) % 7) + 7;
  ...
  return {
    startDate: lastFriday.toISOString(),
...
export const handler = async (event, context) => {
  ...
  try {
    ...
    const insertQuery = `
      INSERT INTO hacker_news_summaries (start_date, end_date, summary, audio_url, created_at, title, summary_type)
